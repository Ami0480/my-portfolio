...
export const Contact = () => {
  ...
  return (
    <footer className="relative z-10 py-16 bg-gradient-to-t from-pink-100/80 to-white/0 mt-0 backdrop-blur-sm">
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between">
        
        {/* Brand */}
        <div className="mb-8 md:mb-0 text-center md:text-left">
           <motion.div 
            className="flex cursor-default relative items-center justify-center md:justify-start"
          >
          ...
          <p className="text-gray-500 text-sm tracking-wider uppercase" style={{ fontFamily: "'Poppins', sans-serif" }}>Front-end Developer</p>
        </div>
        
        {/* Icons */}
        <div className="flex items-center gap-6">
          <SocialLink href="tel:+1234567890" icon={<Phone size={20} />} label="Phone" />
          <SocialLink href="mailto:hello@ami.dev" icon={<Mail size={20} />} label="Email" />
