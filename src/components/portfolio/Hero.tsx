...
export const Hero = () => {
  ...
  return (
    <section ref={containerRef} className="min-h-screen flex flex-col items-center justify-center relative z-10 px-4 text-center pointer-events-none">
      <motion.div 
      ...
      >
        ...
        <motion.p 
          ...
          style={{ fontFamily: "'Poppins', sans-serif" }}
        >
          Crafting digital experiences where fluid design meets precision engineering.
        </motion.p>
      </motion.div>
      ...
      >
        <span className="text-gray-500 text-sm animate-bounce block font-medium">Scroll to explore</span>
      </motion.div>
    </section>
  );
};
